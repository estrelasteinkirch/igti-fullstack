(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[63],{"+dCS":function(e,o,t){"use strict"
...
return o}(p)},"9cv0":function(e,o,t){var c={"./__tests__/handleLtiPostMessages.test.js":["Af1U",716],"./__tests__/lti.resourceImported.test.js":["yySz",655],"./__tests__/requestFullWindowLaunch.test.js":["w8Zi",656],"./handleLtiPostMessage.js":["y+46"],"./lti.resourceImported.js":["75OS",717],"./messageTypes.js":["0YqI"],"./requestFullWindowLaunch.js":["S3m7",718]}
...
var r=t("ouhR")
var n=t.n(r)
function a(e){let o=e.tool,t=e.placement,r=e.acceptedResourceTypes,a=e.targetResourceType,s=e.allowItemSelection,_=e.selectableItems,i=e.onDismiss,d=e.open
const u={com_instructure_course_accept_canvas_resource_types:r,com_instructure_course_canvas_resource_type:a,com_instructure_course_allow_canvas_resource_selection:s,com_instructure_course_available_canvas_resources:_,display:"borderless",placement:t}
...
break
case"lti.setUnloadMessage":_(Object(r["a"])(o.message))
break
case"lti.removeUnloadMessage":i()
break
case"lti.screenReaderAlert":l.a.screenReaderFlashMessageExclusive(o.body.html||o.body)
break
...
return{triggerAssignments:e.reduce((e,o)=>{e[o.trigger_assignment||o.trigger_assignment_id]=o
return e},{}),releasedAssignments:e.reduce((e,o)=>{o.scoring_ranges.forEach(t=>{t.assignment_sets.forEach(c=>{(c.assignments||c.assignment_set_associations).forEach(c=>{const l=c.assignment_id
e[l]=e[l]||[]
e[l].push({assignment_id:o.trigger_assignment||o.trigger_assignment_id,assignment:o.trigger_assignment_model,upper_bound:t.upper_bound,lower_bound:t.lower_bound})})})})
return e},{})}}
let _=s()
...
//# sourceMappingURL=63-c-35f0b99403.js.map